...
public class AddVideoGame implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    ...
    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent input, Context context) {
        ...
        try {
            ...
            VideoGameResponse videoGameResponse = videoGameService.addVideoGame(videoGameRequest);
            return response
                    .withStatusCode(200)
