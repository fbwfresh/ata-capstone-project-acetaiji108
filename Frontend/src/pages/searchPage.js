 ...
 class SearchPage extends BaseClass {
     constructor() {
         super();
         this.bindClassMethods(['onFindByName', 'renderByVideoGameName', 'renderByVideoGameNameSearch'], this);
 ...
 //        const game = this.dataStore.get("VideoGame");
     ...
     async renderByVideoGameNameSearch(){
             const videoGameResultArea = document.getElementById("searchResult");
             const game = this.dataStore.get("VideoGame");
             console.log(game);
             let upvote = game.UpwardVote;
 ...
 //            window.location.href = "searchPage.html";
             this.renderByVideoGameNameSearch();
         } else{
